...
parameters = torch.load("/S/home00/G3506/p0814/diffseis/results/demultiple_0110-20k_step1k/model-final.pt", map_location=torch.device('cuda'))['model']
